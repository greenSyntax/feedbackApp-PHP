		...
		class DbManager{
			...
			//Insert Feedback
			function insertData($user_name, $feedback_text){

				if($this->conn){

				$time_stamp = date("Y-m-d h:i:s");

				$sql = "INSERT INTO `".TBL_FEEDBACK."` (`feedback_id`, `user_name`, `feedback_text`, `user_mail`, `time_stamp`, `processing_status`) VALUES (NULL, '".$user_name."', '".$feedback_text."', NULL, '".$time_stamp."',0)";
